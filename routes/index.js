...
function bitluUpdateIhd(AmazonMsg){
  ...
  request({
    uri: "https://postmanual5.herokuapp.com/bitlyChangePostAmzn",
    method: "POST",
...
function tagChangeRandoms(AmazonMsg){
  ...
  tagChangeRandomsUpdate(randomMonth.tag_name);
   let requestHeaders1 = {
    ...
    request({
      uri: "https://postmanual5.herokuapp.com/tagChangePostAmazon",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
  linkRequest1 = {
    ...
    request({
      uri: "https://api.chat-api.com/instance221160/sendMessage?token=77ixqwoxw8fcpo0e",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
  linkRequest1 = {
    ...
    request({
      uri: "https://api.chat-api.com/instance221161/sendMessage?token=9gejo0pylvh8xvh9",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
    ...
    request({
      uri: "https://api.chat-api.com/instance221160/sendFile?token=77ixqwoxw8fcpo0e",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
    ...
    request({
      uri: "https://api.chat-api.com/instance221161/sendFile?token=9gejo0pylvh8xvh9",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
