...
function bitluUpdateIhd(AmazonMsg){
  ...
  request({
    uri: "https://postmanual4.herokuapp.com/bitlyChangePostAmzn",
    method: "POST",
...
function tagChangeRandoms(AmazonMsg){
  ...
  tagChangeRandomsUpdate(randomMonth.tag_name);
   let requestHeaders1 = {
    ...
    request({
      uri: "https://postmanual4.herokuapp.com/tagChangePostAmazon",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
  linkRequest1 = {
    ...
    request({
      uri: "https://api.chat-api.com/instance211537/sendMessage?token=og4o4d4uibf57dco",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
  linkRequest1 = {
    ...
    request({
      uri: "https://api.chat-api.com/instance211536/sendMessage?token=0h34prq3tntgoqp6",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
    ...
    request({
      uri: "https://api.chat-api.com/instance211537/sendFile?token=og4o4d4uibf57dco",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
    ...
    request({
      uri: "https://api.chat-api.com/instance211536/sendFile?token=0h34prq3tntgoqp6",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
