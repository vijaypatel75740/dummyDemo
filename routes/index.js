...
function bitluUpdateIhd(AmazonMsg){
  ...
  request({
    uri: "https://postmanual2.herokuapp.com/bitlyChangePostAmzn",
    method: "POST",
...
function tagChangeRandoms(AmazonMsg){
  ...
  tagChangeRandomsUpdate(randomMonth.tag_name);
   let requestHeaders1 = {
    ...
    request({
      uri: "https://postmanual2.herokuapp.com/tagChangePostAmazon",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
  linkRequest1 = {
    ...
    request({
      uri: "https://api.chat-api.com/instance192416/sendMessage?token=g6mu1csaxddded81",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
  linkRequest1 = {
    ...
    request({
      uri: "https://api.chat-api.com/instance192417/sendMessage?token=gp6erpk568d81iho",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
    ...
    request({
      uri: "https://api.chat-api.com/instance192416/sendFile?token=g6mu1csaxddded81",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
...
let linkRequest1;
    ...
    request({
      uri: "https://api.chat-api.com/instance192417/sendFile?token=gp6erpk568d81iho",
      method: "POST",
      body: JSON.stringify(linkRequest1),
      headers: requestHeaders1
    }, (err, response, body) => {
